...
public class MainRunner {
    public static void main(String[] args) {
        ...
        Drum drum = new Drum(20, "Will have good capacity", 2.5);
        ...
        Switch aSwitch = new Switch(97, "Switch", 97.1);
        System.out.println(aSwitch);
        System.out.println(aSwitch.hashCode());
        System.out.println("Original: " + System.identityHashCode(aSwitch));
        System.out.println("*****************************************************************");

        Drill drill = new Drill(42, "Drill", 42.1);
        ...
        Bolt bolt = new Bolt(49, "Bolt", 49.1);
